module ShopifyApp
  class CarrierServicesManager
    ...
    def self.queue(shop_domain, shop_token, carrier_services)
      ShopifyApp::CarrierServicesManagerJob.perform_later(
    ...
    attr_reader :required_carrier_services

    def initialize(carrier_services)
      @required_carrier_services = carrier_services
    end
